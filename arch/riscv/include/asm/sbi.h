...
enum sbi_ext_dbcn_fid {
	SBI_EXT_DBCN_CONSOLE_PUTS = 0,
};

enum sbi_ext_nacl_fid {
	SBI_EXT_NACL_SET_SHMEM = 0x0,
	SBI_EXT_NACL_SYNC_CSR = 0x1,
	SBI_EXT_NACL_SYNC_HFENCE = 0x2,
	SBI_EXT_NACL_SYNC_SRET = 0x3,
};

#define SBI_NACL_SHMEM_ADDR_SHIFT	12
#define SBI_NACL_SHMEM_SCRATCH_OFFSET	0x2000
#define SBI_NACL_SHMEM_SCRATCH_SIZE	0x800
#define SBI_NACL_SHMEM_HFENCE_OFFSET	(SBI_NACL_SHMEM_SCRATCH_OFFSET + \
					 SBI_NACL_SHMEM_SCRATCH_SIZE)
#define SBI_NACL_SHMEM_HFENCE_SIZE	0x780
#define SBI_NACL_SHMEM_DBITMAP_OFFSET	(SBI_NACL_SHMEM_HFENCE_OFFSET + \
					 SBI_NACL_SHMEM_HFENCE_SIZE)
#define SBI_NACL_SHMEM_DBITMAP_SIZE	0x80
...
#define SBI_NACL_SHMEM_HFENCE_ENTRY_SZ		((__riscv_xlen / 8) * 3)
...
#define SBI_NACL_SHMEM_HFENCE_ENTRY_PADDR(__num)\
...
#endif
#define SBI_NACL_SHMEM_HFENCE_CTRL_PSIZE_BITS	7
#define SBI_NACL_SHMEM_HFENCE_CTRL_TYPE_BITS	3
...
#define SBI_NACL_SHMEM_HFENCE_CTRL_PSIZE_MASK	\
		((1UL << SBI_NACL_SHMEM_HFENCE_CTRL_PSIZE_BITS) - 1)
#define SBI_NACL_SHMEM_HFENCE_CTRL_PSIZE_SHIFT	(__riscv_xlen - 12)
#define SBI_NACL_SHMEM_HFENCE_CTRL_TYPE_MASK	\
		((1UL << SBI_NACL_SHMEM_HFENCE_CTRL_TYPE_BITS) - 1)
#define SBI_NACL_SHMEM_HFENCE_CTRL_TYPE_SHIFT	\
		(__riscv_xlen - SBI_NACL_SHMEM_HFENCE_CTRL_TYPE_BITS)
#define SBI_NACL_SHMEM_HFENCE_CTRL_PEND_MASK	\
		((1UL << SBI_NACL_SHMEM_HFENCE_CTRL_PEND_BITS) - 1)
#define SBI_NACL_SHMEM_HFENCE_CTRL_PEND_SHIFT	\
		(__riscv_xlen - SBI_NACL_SHMEM_HFENCE_CTRL_PEND_BITS)
#define SBI_NACL_SHMEM_HFENCE_CTRL_PEND		\
		(SBI_NACL_SHMEM_HFENCE_CTRL_PEND_MASK << \
		 SBI_NACL_SHMEM_HFENCE_CTRL_PEND_SHIFT)

#define SBI_NACL_SHMEM_HFENCE_PSIZE_MIN		12
#define SBI_NACL_SHMEM_HFENCE_PSIZE_MAX		(__riscv_xlen - 1)
...
#define SBI_NACL_SRET_FLAG_VMEXIT_HSTATUS	(1 << 0)
...
/* SBI APTEE extension data structures */
enum sbi_ext_teeh_fid {
	SBI_EXT_TEEH_TSM_GET_INFO = 0,
	SBI_EXT_TEEH_TSM_CONVERT_PAGES,
	SBI_EXT_TEEH_TSM_RECLAIM_PAGES,
	SBI_EXT_TEEH_TSM_INITIATE_FENCE,
	SBI_EXT_TEEH_TSM_LOCAL_FENCE,
	SBI_EXT_TEEH_CREATE_TVM,
	SBI_EXT_TEEH_FINALIZE_TVM,
	SBI_EXT_TEEH_DESTROY_TVM,
	SBI_EXT_TEEH_TVM_ADD_MEMORY_REGION,
	SBI_EXT_TEEH_TVM_ADD_PGT_PAGES,
	SBI_EXT_TEEH_TVM_ADD_MEASURED_PAGES,
	SBI_EXT_TEEH_TVM_ADD_ZERO_PAGES,
	SBI_EXT_TEEH_TVM_ADD_SHARED_PAGES,
	SBI_EXT_TEEH_TVM_CREATE_VCPU,
	SBI_EXT_TEEH_TVM_VCPU_RUN,
	SBI_EXT_TEEH_TVM_INITIATE_FENCE,
};

enum sbi_ext_teei_fid {
	SBI_EXT_TEEI_TVM_AIA_INIT,
	SBI_EXT_TEEI_TVM_CPU_SET_IMSIC_ADDR,
	SBI_EXT_TEEI_TVM_CONVERT_IMSIC,
	SBI_EXT_TEEI_TVM_RECLAIM_IMSIC,
	SBI_EXT_TEEI_TVM_CPU_BIND_IMSIC,
	SBI_EXT_TEEI_TVM_CPU_UNBIND_IMSIC_BEGIN,
	SBI_EXT_TEEI_TVM_CPU_UNBIND_IMSIC_END,
	SBI_EXT_TEEI_TVM_CPU_INJECT_EXT_INTERRUPT,
	SBI_EXT_TEEI_TVM_REBIND_IMSIC_BEGIN,
	SBI_EXT_TEEI_TVM_REBIND_IMSIC_CLONE,
	SBI_EXT_TEEI_TVM_REBIND_IMSIC_END,
};

enum sbi_tee_page_type {
	SBI_TEE_PAGE_4K,
	SBI_TEE_PAGE_2MB,
	SBI_TEE_PAGE_1GB,
	SBI_TEE_PAGE_512GB,
...
enum sbi_tee_mem_type {
	TVM_MEM_REGION_TYPE_CONFIDENTIAL = 0,
	TVM_MEM_REGION_TYPE_SHARED,
	TVM_MEM_REGION_TYPE_MMIO,
};

struct sbi_tee_tsm_info {
	/* Current state of the TSM */
	enum sbi_tee_tsm_state tstate;
...
struct sbi_tee_tvm_create_params {
